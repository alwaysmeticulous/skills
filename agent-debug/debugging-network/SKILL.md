...
description: Investigate network-related replay failures and divergences. Only use inside a workspace created by `npx @alwaysmeticulous/cli agent debug` — requires the debug-data/ directory to be present.
---
...
- If you changed your API, recorded responses may no longer be valid.
