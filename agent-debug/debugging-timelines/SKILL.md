...
description: Investigate timeline divergence between head and base replays. Only use inside a workspace created by `npx @alwaysmeticulous/cli agent debug` — requires the debug-data/ directory to be present.
---
